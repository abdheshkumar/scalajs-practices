...
import joint.shapes.devs.{Model, ModelOptions, Props}
...
object BaseNode extends ExtenderOps {
  ...
  def apply(options: js.UndefOr[ModelOptions] = js.undefined,
            ...
            staticProperties: js.UndefOr[StaticProperties] = js.undefined): BaseNode =
    js.Dynamic.newInstance(nodeClass)(options, prototypeProperties, staticProperties).asInstanceOf[BaseNode]
}